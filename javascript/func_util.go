...
SumToString("4611686027042965191", 11)`,
		...
		},
		{
			...
			Comment: `值 转 int64
ValueToInt64("11")`,
			Func:    util.ValueToInt64,
		},
		{
			Name:    "valueToUint64",
			Comment: `值 转 uint64
ValueToUint64("11")`,
			Func:    util.ValueToUint64,
		},
		{
			Name:    "valueToFloat64",
			Comment: `值 转 float64
ValueToFloat64("11")`,
			Func:    util.ValueToFloat64,
		},
		{
...
TimeFormat(time, "2006-01-02 15:04:05")`,
		...
		{
			Name:    "milliToTimeText",
			Comment: `将 毫秒 转为 'xx天xx时xx分xx秒xx毫秒'`,
			Func:    util.MilliToTimeText,
		},
		{
			Name:    "getUUID",
			Comment: `生成UUID
